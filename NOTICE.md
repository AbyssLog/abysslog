...
Copyright © 2026 Erinys.

AbyssLog-authored software and documentation are available under the
[MIT License](LICENSE).

The MIT license grant applies only to material for which the AbyssLog copyright
holder has authority to grant rights. It does not grant rights to EVE Online
game data, third-party material, or trademarks belonging to Fenris Creations,
CCP hf., or anyone else.
...
Dependencies bundled with AbyssLog remain subject to their own licenses and
notices.
