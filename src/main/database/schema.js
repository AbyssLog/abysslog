const { CURRENT_SCHEMA_CONTRACT } = require('./schema-contract-v6');
const { createFreshSchemaV6, SCHEMA_VERSION_V6 } = require('./schema-v6');
const { getSchemaIssues, tableColumns } = require('./schema-validator');

const ABYSSLOG_APPLICATION_ID = 0x4142594c;
const SCHEMA_VERSION = SCHEMA_VERSION_V6;
...
module.exports = {
  ...
  SCHEMA_VERSION,
  createSchema: createFreshSchemaV6,
